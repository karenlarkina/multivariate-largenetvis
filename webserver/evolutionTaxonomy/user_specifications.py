...
User can specify:
    ...
    what to print
"""
from evolutionTaxonomy.constants import Ts
import numpy as np
from random import sample
from evolutionTaxonomy.test_integrity import test_changes_integrity, test_degree_distribution
...
def print_parameters():
    ...
    community_events_t1 = False
    exclude_continuations = False
